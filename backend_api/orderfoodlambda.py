...
def order_food(intent_request):
    ...
    itemnameone = try_ex(lambda: intent_request['currentIntent']['slots']['Itemnameone'])
    quantityone = safe_int(try_ex(lambda: intent_request['currentIntent']['slots']['Quantityone']))
    addmore = try_ex(lambda: intent_request['currentIntent']['slots']['Addmore'])
    itemnametwo = try_ex(lambda: intent_request['currentIntent']['slots']['Itemnametwo'])
    quantitytwo = safe_int(try_ex(lambda: intent_request['currentIntent']['slots']['Quantitytwo']))
    ...
    session_attributes['currentOrder'] = orderfood
    ...
    logger.debug('OrderFood under={}'.format(orderfood))
    ...
    r = http.request("POST", "https://us-central1-assignment4-355202.cloudfunctions.net/lex-order-food",body=json.dumps(sendfoodorder),headers={'Content-Type': 'application/json'})
    print(r)
    ...
    # s = http.request("GET", "https://us-central1-assignment4-355202.cloudfunctions.net/get-room",headers={'Content-Type': 'application/json'})
    # # newname=json.loads(s)
    # data = json.loads(s.data)
    # print(data)


    # dynamodb = boto3.client("dynamodb", region_name='us-east-1')
    # dynamodb.put_item(TableName="bookroom",
    #     Item = {
    ...
    return close(
        ...
        'Fulfilled',
        {
            ...
            'content': 'Thanks your order has been placed. Please find the order details ' + 'Room no: ' + str(roomnumber) + ' , First Item ' + str(itemnameone) + ' , Quantity  : ' + str(quantityone) + ', Second item : ' + str(itemnametwo) + ' , Quantity: ' + str(quantitytwo)  + ' Type hi to go back to main menu'
